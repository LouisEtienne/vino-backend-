...
class Cellier extends Modele {
	...
	public function modifierQuantiteBouteilleCellier($id_cellier, $id_bouteille, $nombre) //$id_cellier??? et $id_bouteille
	{
		//TODO : Valider les données.
	...
	public function getQuantite($id_cellier, $id_bouteille){
		$requete = "SELECT quantite FROM vino__celiier WHERE id = ". $id_cellier ." AND id_bouteille = ".$id_bouteille.";";
		//echo $requete;
        return $this->_db->query($requete);
	}
